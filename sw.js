/* ==================================================================
   ...
   Mỗi lần deploy bản mới: đổi số ở PHIENBAN (v1 → v2 → v3 → v4…).
   Lần này: v3 -> v4 để đẩy bản vá BỘ THU LỖI (thêm lọc nhiễu Service Worker
   "Failed to update a ServiceWorker for scope") — đổi PHIENBAN thì máy khách
   mới nạp Service Worker mới và tải index.html mới.
   ================================================================== */
const PHIENBAN  = "v4";                              // đã tăng v3 -> v4 để đẩy bản vá
