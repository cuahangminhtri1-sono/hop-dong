/* ==================================================================
   sw.js — bộ nhớ đệm ngoại tuyến cho app HTML một tệp  (admin + HD, Firebase 10.12.5)
   ...
   ================================================================== */
const PHIENBAN  = "v2";                              // đã tăng v1 -> v2 để đẩy bản vá
...
/* ⚠️ SỐ PHIÊN BẢN PHẢI KHỚP TỪNG CHỮ với dòng import trong index.html.
   admin + HD dùng 10.12.5. Chép nhầm 10.12.0 là mất mạng app đứng im
   ở màn hình trắng vì không nạp được thư viện. */
const NGOAI = [
